...
![Deployment Status](https://github.com/esTse/acto-pide-contacto/actions/workflows/deploy.yml/badge.svg)
...
-   **Deployment (`deploy.yml`)**: Handles the deployment of the service to our internal processing cluster. This workflow is triggered via issue comments (ChatOps). To deploy a hotfix, comment `/deploy <hotfix_name>` on any open issue.
